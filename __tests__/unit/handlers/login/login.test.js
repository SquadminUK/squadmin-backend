...
const lambda = require('../../../../src/handlers/login/login');
...
describe('Test postLoginHandler', () => {
    ...
    it('should not accept the PUT http method', async () => {
        ...
        const expectedResult = {
            "message": "Bad request", 
            "reason": "postLoginHandler only accepts POST method, you tried: PUT", 
            "statusCode": 400
        };
    ...
    it('should not accept the GET http method', async done => {
        ...
        const expectedResult = {
            "message": "Bad request", 
            "reason": "postLoginHandler only accepts POST method, you tried: GET", 
            "statusCode": 400
        };
